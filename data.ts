...
const prajna: Volume[] = [
  ...createSutraVolumes(1000, 67, 1, '大般若波羅蜜多經', 600),
  ...createSutraVolumes(2000, 68, 2, '放光般若波羅蜜經', 30),
  ...createSutraVolumes(3000, 69, 3, '摩訶般若波羅蜜經', 30),
  ...createSutraVolumes(4000, 70, 4, '光讚般若波羅蜜經', 10),
  ...createSutraVolumes(5000, 71, 5, '道行般若波羅蜜經', 10),
  ...createSutraVolumes(6000, 75, 6, '小品般若波羅蜜經', 10),
  ...createSutraVolumes(7000, 76, 7, '摩訶般若波羅蜜鈔經', 5),
  ...createSutraVolumes(8000, 80, 9, '勝天王般若波羅蜜經', 7),
  ...createSutraVolumes(9000, 90, 19, '文殊師利所說般若波羅蜜經', 1),
];
